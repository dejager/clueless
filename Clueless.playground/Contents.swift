...
* mobile device.
* Progam your own shader function in `playgroundSample` in Clueless.metal. You
...
do {
  let path = Bundle.main.path(forResource: "Clueless", ofType: "metal")
